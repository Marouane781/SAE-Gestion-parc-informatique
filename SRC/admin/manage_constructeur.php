...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($nom !== '') {
        ...
        $message = $ok ? 'Constructeur ajouté.' : 'Erreur : ' . mysqli_error($mysqli);
        mysqli_stmt_close($stmt);
    } else {
        $message = 'Nom obligatoire.';
    }
}
$result = mysqli_query($mysqli, "SELECT id, nom FROM constructeur ORDER BY nom");
?>
<!doctype html>
<html lang="fr">
<head>
  <meta charset="utf-8">
  <title>Gérer les constructeurs</title>
...
<body>
  ...
  <main class="container">
    <div class="card">
      ...
      <?php endif; ?>
      <form class="form" method="post" action="manage_constructeur.php">
